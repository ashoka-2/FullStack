...
const AdminUnitsPage = () => {
    ...
    const filteredUnits = units.filter(u => {
        ...
        return u.name?.toLowerCase().includes(q) || u.abbreviation?.toLowerCase().includes(q) || u.description?.toLowerCase().includes(q);
    });
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    placeholder="Search units by name, abbreviation or description…"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                {filteredUnits.length === 0 && (
                    <div className="col-span-full py-20 flex flex-col items-center justify-center gap-3 text-foreground/25 border border-dashed border-border-theme/40 rounded-3xl bg-surface/10">
                        ...
                        <p className="text-sm font-black uppercase tracking-widest">No units found</p>
                    </div>
                )}
            </div>
        </div>
