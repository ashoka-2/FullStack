import {setProducts,setSellerProducts,setLoading,setError} from "../State/product.slice";
...
export const useProduct = () =>{
    ...
    async function handleGetSellerProducts(){
        ...
        try{
            ...
            dispatch(addToast({message:"Seller Products fetched successfully!",type:"success"}))
            return data
        }
        catch(error){
