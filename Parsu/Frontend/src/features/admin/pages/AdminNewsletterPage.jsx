  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Newsletter Audience</h1>
        ...
        <div className="flex items-center gap-2">
          {subscribers.length > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-xs font-semibold text-zinc-300 border border-white/10 transition-colors cursor-pointer"
            >
              {copied ? <RiCheckFill size={14} className="text-emerald-400" /> : <RiFileCopyLine size={14} />}
      ...
      {/* Search Toolbar */}
      <div className="p-3 rounded-2xl bg-[#11131a]/80 border border-white/[0.08]">
