    ...
    <div className="min-h-screen w-full bg-[var(--bg-primary)] text-zinc-900 dark:text-zinc-100 flex flex-col justify-between selection:bg-[var(--accent-cyan)]/30 selection:text-white transition-colors duration-300 relative overflow-x-hidden">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-8 text-center max-w-3xl mx-auto">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 text-sm sm:text-base leading-relaxed max-w-xl mb-8">
          Parsu is currently undergoing brief technical maintenance to upgrade AI model clusters and optimize response speeds. All user data, chats, and keys are safely secured.
        </p>
