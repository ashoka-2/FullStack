    ...
    <div className="nav-container">
     ...
     {/* Logo Section */}
        ...
        <div className="nav-bottom-links">
          <div onClick={onLogoutClick} className="nav-item">
